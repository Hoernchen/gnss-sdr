    ...
    case 2:
        {
            ...
            // LOG(ERROR) << "d_mag " << d_mag << ".d_sample_counter " << d_sample_counter << ". acq delay " << d_gnss_synchro->Acq_delay_samples<< " indext "<< indext << std::endl;
            ...
            if (d_CAF_window_hz > 0)
                {
                    ...
                    // weighting_factor = 0;
                    // LOG(ERROR) << "weighting_factor " << weighting_factor << std::endl;
